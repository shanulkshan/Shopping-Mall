  ...
  export default function Createshop() {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const res = await fetch("/api/product/Ccreate", {
          method: "POST",
          headers: {
    ...
    return (
      ...
      <div className="">
        <h1 className="text-center text-3xl my-7 ml-10 font-medium">New Product</h1>
        ...
        <form className="flex flex-col gap-4 w-[600px]  rounded-lg border-none  bg-gray-50  mb-10 mt-5" onSubmit={handleSubmit}>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (value >= 0) {
                  ...
                  setPublishError('quntity cannot be negative');  // Set error message
                }
              }}
            />
            <input
              ...
              onChange={(e) => {
                ...
                if (value >= 0) {
                  ...
                  setPublishError('Price cannot be negative');  // Set error message
                }
              }}
            />
          </div>
          ...
          {publishError && (
            <p className="mt-2 text-red-600  w-300 h-7 rounded-lg text-center ">
              {publishError}
            </p>
          )}
        </form>
