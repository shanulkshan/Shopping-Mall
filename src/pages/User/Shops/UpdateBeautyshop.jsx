import {
  ...
  export default function UpdateBeautyshop() {
      ...
      try {
        const fetchForm = async () => {
          const res = await fetch(
            `/api/beauty/BgetAll?UupdateId=${updateBId}`
          );
          ...
          if (res.ok) {
            const selectedform = data.getbeaty.find((formm) => formm._id === updateBId);
            if (selectedform) {
